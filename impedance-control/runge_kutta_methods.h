...
typedef vector<double>(*STATEMODEL)(double t, vector<double> &y0, vector<double> &dy, const double other_parameter);
...
public:
	...
	vector<double> integrate(const double t, vector<double> &y0, vector<double> &dy, const double other_parameter);
